...
const VideoDetailsDetails = (props) => {
                        ...
                        <div className="wpo-blog-content">
                            <div className="post format-video">
                                ...
                                <div className="entry-meta">
                                    <ul>
                                        <li><i className="fi flaticon-user"></i> By <Link to="/highlight-single/Perfect-Photo">{BlogDetails.author}</Link> </li>
                            ...
                            <div className="tag-share clearfix">
                                <div className="tag">
                                    <span>Share: </span>
                                    <ul>
                                        <li><Link to="/highlight-single/Perfect-Photo">Travels</Link></li>
                                        <li><Link to="/highlight-single/Perfect-Photo">Lifestyle</Link></li>
                                        <li><Link to="/highlight-single/Perfect-Photo">Food</Link></li>
                                    </ul>
                                </div>
                            </div>
                            <div className="tag-share-s2 clearfix">
                                <div className="tag">
                                    <span>Share: </span>
                                    <ul>
                                        <li><Link to="/highlight-single/Perfect-Photo">facebook</Link></li>
                                        <li><Link to="/highlight-single/Perfect-Photo">twitter</Link></li>
                                        <li><Link to="/highlight-single/Perfect-Photo">linkedin</Link></li>
                                        <li><Link to="/highlight-single/Perfect-Photo">pinterest</Link></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="author-box">
                                <div className="author-avatar">
                                    <Link to="/highlight-single/Perfect-Photo" target="_blank"><img src={blog6} alt="" /></Link>
                                </div>
                                <div className="author-content">
                                    <Link to="/highlight-single/Perfect-Photo" className="author-name">Author: Jenny Watson</Link>
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</p>
                                    <div className="socials">
                                        <ul className="social-link">
                                            <li><Link to="/highlight-single/Perfect-Photo"><i className="ti-facebook"></i></Link></li>
                                            <li><Link to="/highlight-single/Perfect-Photo"><i className="ti-twitter-alt"></i></Link></li>
                                            <li><Link to="/highlight-single/Perfect-Photo"><i className="ti-linkedin"></i></Link></li>
                                            <li><Link to="/highlight-single/Perfect-Photo"><i className="ti-instagram"></i></Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div className="comment-wrapper">
                                                        ...
                                                        <div className="comment-area">
                                                            ...
                                                            <div className="comments-reply">
                                                                <Link className="comment-reply-link" to="/highlight-single/Perfect-Photo"><span>Reply</span></Link>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
