                        ...
                        <div className="wpo-blog-content">
                            <div className="post format-standard-image">
                                ...
                                <div className="entry-meta">
                                    <ul>
                                        <li><i className="fi flaticon-user"></i> By <Link to="/sponsor-single/Beautiful-Scenery">{BlogDetails.author}</Link> </li>
                            ...
                            <div className="tag-share clearfix">
                                <div className="tag">
                                    <span>Share: </span>
                                    <ul>
                                        <li><Link to="/sponsor-single/Beautiful-Scenery">Travels</Link></li>
                                        <li><Link to="/sponsor-single/Beautiful-Scenery">Lifestyle</Link></li>
                                        <li><Link to="/sponsor-single/Beautiful-Scenery">Food</Link></li>
                                    </ul>
                                </div>
                            </div>
                            <div className="tag-share-s2 clearfix">
                                <div className="tag">
                                    <span>Share: </span>
                                    <ul>
                                        <li><Link to="/sponsor-single/Beautiful-Scenery">facebook</Link></li>
                                        <li><Link to="/sponsor-single/Beautiful-Scenery">twitter</Link></li>
                                        <li><Link to="/sponsor-single/Beautiful-Scenery">linkedin</Link></li>
                                        <li><Link to="/sponsor-single/Beautiful-Scenery">pinterest</Link></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="author-box">
                                <div className="author-avatar">
                                    <Link to="/sponsor-single/Beautiful-Scenery" target="_blank"><img src={blog6} alt="" /></Link>
                                </div>
                                <div className="author-content">
                                    <Link to="/sponsor-single/Beautiful-Scenery" className="author-name">Author: Jenny Watson</Link>
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</p>
                                    <div className="socials">
                                        <ul className="social-link">
                                            <li><Link to="/sponsor-single/Beautiful-Scenery"><i className="ti-facebook"></i></Link></li>
                                            <li><Link to="/sponsor-single/Beautiful-Scenery"><i className="ti-twitter-alt"></i></Link></li>
                                            <li><Link to="/sponsor-single/Beautiful-Scenery"><i className="ti-linkedin"></i></Link></li>
                                            <li><Link to="/sponsor-single/Beautiful-Scenery"><i className="ti-instagram"></i></Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div className="comment-wrapper">
                                                        ...
                                                        <div className="comment-area">
                                                            ...
                                                            <div className="comments-reply">
                                                                <Link className="comment-reply-link" to="/sponsor-single/Beautiful-Scenery"><span>Reply</span></Link>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
